...
namespace NotSocialNetwork.DBContexts
{
    public static class TestData
    {
        ...
        private static IEnumerable<PublicationEntity> GetPublications()
        {
            ...
            {
                new PublicationEntity() { Title = "Some title1", Author = _userEntity1, Images = new List<ImageEntity>() { _imageEntity1, _imageEntity2 }, Text = "Some text 1", },
                new PublicationEntity() { Title = "Some title2", Author = _userEntity2, Images = new List<ImageEntity>() { _imageEntity3 }, Text = "Some text 2" }
            };
            return publications;
        }
    }
