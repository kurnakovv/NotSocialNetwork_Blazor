...
namespace NotSocialNetwork.WebShared.Helpers
{
    ...
    public static class CookieHelper
    {
        ...
        /// </returns>
        public static async Task<bool> EditNightThemeCookies(ILocalStorageService localStorage)
        {
        ...
        /// <param name="localStorage">A class containing methods for working with cookies.</param>
        /// <returns></returns>
        public static async Task<Guid> GetCurrentId(ILocalStorageService localStorage)
        {
        ...
        /// <param name="localStorage">A class containing methods for working with cookies.</param>
        /// <returns></returns>
        public static async Task<string> GetEmailAtCookies(ILocalStorageService localStorage)
        {
        ...
        /// <param name="email">New value for email cookie.</param>
        /// <returns></returns>
        public static async Task<bool> SetNewUserCookies
